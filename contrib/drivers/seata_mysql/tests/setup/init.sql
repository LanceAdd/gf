-- =====================================================
-- Seata MySQL Driver Test Database Initialization Script
-- =====================================================

-- 1. 创建数据库
DROP DATABASE IF EXISTS seata_test;
CREATE DATABASE seata_test DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
('Apple Watch', 2999.00, 150);        -- 产品5（用于压力测试）
...
-- 订单表：orders (0条记录)
-- 产品表：products (5条记录)
-- 订单明细表：order_items (0条记录)
-- Undo Log表：undo_log (AT模式使用)
-- 
-- 现在可以运行测试用例：
-- Unit Tests: go test ./unit/...
-- Integration Tests: go test ./integration/...
-- Advanced Tests: go test ./advanced/...
-- =====================================================