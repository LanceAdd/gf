...
require (
	github.com/gogf/gf/contrib/drivers/seata_mysql v0.0.0
	github.com/gogf/gf/v2 v2.9.6
	github.com/seata/seata-go v1.2.0
	github.com/stretchr/testify v1.11.1
)

replace github.com/gogf/gf/contrib/drivers/seata_mysql => ../
...
require (
	...
	github.com/gogf/gf/contrib/drivers/mysql/v2 v2.9.6 // indirect
